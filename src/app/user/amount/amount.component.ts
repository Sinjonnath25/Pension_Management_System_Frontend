      ...
      .subscribe((res:any)=>{
        ...
        this.clicked = false;
          ...
          if(res.status==200 && res.data !=null){
            ...
            this.load="";
            this.responseMsg = "Pension amount for Aadhar No "+this.pensionDetais.aadharNo+" is Rs."+this.pensionDetais.pensionAmount+"\n"
            this.responseMsg1="Applicable Bank Service Charge Will be Rs."+this.pensionDetais.bankServiceCharge;
          }
          else{
            console.log(res);
            this.load="";
